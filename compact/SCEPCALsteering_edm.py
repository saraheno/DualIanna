...
def edm4HepUserPlugin(dd4hepSimulation):
     from DDG4 import EventAction, Kernel
     dd = dd4hepSimulation
     evt_root = EventAction(Kernel(), 'CVGeant4Output2EDM4hep/'+dd.outputFile, True)
...
def exampleUserPlugin(dd4hepSimulation):
     ...
     return None
#SIM.outputConfig.userOutputPlugin = exampleUserPlugin
SIM.outputConfig.userOutputPlugin = edm4HepUserPlugin
